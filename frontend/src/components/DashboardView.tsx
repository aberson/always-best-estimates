/**
 * The dashboard (default route `/`): RunHeader + one card per pipeline stage,
 * fed by polling `GET /api/runs/latest` every POLL_INTERVAL_MS.
 *
 * This is the V1 UI, moved verbatim out of App.tsx (which became the router
 * shell in Track 2 Step 26) — its behavior is unchanged.
 *
